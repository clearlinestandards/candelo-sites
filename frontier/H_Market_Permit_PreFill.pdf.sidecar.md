---
title: Sidecar — H_Market_Permit_PreFill.pdf
type: non-text capture sidecar (pdf text)
source_binary: _deploy/candelo-sites/frontier/H_Market_Permit_PreFill.pdf
...
# H_Market_Permit_PreFill.pdf — readable sidecar

Real file (not readable by the graph): `_deploy/candelo-sites/frontier/H_Market_Permit_PreFill.pdf`
